...
/*
	...
	error:		NULL at EOF (not really an error
			calls fetal from emalloc()
	note:		allocates space in BUFSIZE chunks.
*/
{
	char *buf;		/*the buffer	*/
