...
#include <time.h>
#include <strings.h>
#define     PORTNUM 13000   /* out time service phone number    */
#define     HOSTLEN 256
...
int main(int ac, char *av[])
{
    ...
    */
    ...
    /*
    *   Step2: bind address to socket. Adderss is host, port
    */
    ...
    /*
    *   Step3: allow incomming calls with Qsize=1 on socket     
    */
